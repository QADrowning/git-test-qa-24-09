...
describe('fullTrim function', () => {
  ...
  test.each(data)('should return string without trim', ({ text, expected }) => {
...
describe('getTotal function', () => {
  ...
  test.each(data_positive)('valid count', ({ items, discount, expected }) => {
    expect(getTotal(items, discount)).toBe(expected)
  })

  test.each(data_negative)(
    'should return discount warning',
    ({ items, discount }) => {
      expect(() => {
